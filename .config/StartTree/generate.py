...
# get base directory
base_dir = home + '/.config/StartTree'
...
def gen_html(file_dict):
    ...
    # open files
    skeleton_html = open(base_dir + '/skeletons/index.html', 'r')
    cache_html = open(base_dir + '/index.html', 'w+')
...
def gen_style(file_dict):
    skeleton_style = open(base_dir + '/skeletons/style.css', 'r')
    cache_style = open(base_dir + '/styles/style.css', 'w')
    ...
    if theme == "pywal":
        ...
        theme = base_dir + '/themes/' + theme + '.css'

    copyfile(theme, base_dir + '/styles/colors.css')
